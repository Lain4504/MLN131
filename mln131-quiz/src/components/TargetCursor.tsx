...
const TargetCursor = ({
  targetSelector = '.cursor-target, button, a, input, [role="button"]',
  spinDuration = 2,
  ...
  const moveCursor = useCallback((x: number, y: number) => {
    ...
    // Ensure cursor follows mouse precisely
  ...
  useEffect(() => {
    ...
    cursor.style.transform = `translate(${initX}px, ${initY}px) translate(-50%, -50%)`;
